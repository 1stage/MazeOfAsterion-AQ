...
| Call | State In | Branch | Counter After (H,L) | Position Before | Position After |
| ---: | :------- | :----- | :------------------ | :-------------- | :------------- |
...
Notes:
- Large steps occur on calls 3, 6, 9, 12, 15, 18, and 21. The attempted 8th large step would target **$3342** (row 20, col 34), but the loop exits before moving/drawing because the counter reaches 0000.
