...
**Visual Representation - FL2 Wall (visible through gap):**
...
Legend: ⬛🟫 Background | 🟦 FL2 Wall (4 cols wide, rows 9-13)

**Note**:
- **L1** is the main left wall at distance 1 (columns 4-7, rows 5-18)
- **FL1_B** is the back section of the front-left wall (columns 6-9, rows 6-13)
- **FL2** is visible at distance 2 when L1/FL1_B have no walls (columns 10-13, rows 9-13)
- Drawing routines: `DRAW_WALL_L1`, `DRAW_L1`, `DRAW_WALL_FL1_B`, `DRAW_DOOR_FL1_B_*`, `DRAW_WALL_FL2`
