...
**Visual Representation - FL1_A and FL1_B Wall and Door:**
...
Legend: ⬛🟫 Background | 🟪 FL1_A Wall | 🟦 FL1_B Wall | 🟩 FL1_A Door | 🟧 FL1_B Door
...
- **FL1_A and FL1_B** are the front-left wall sections at distance 1 (columns 0-7, rows 8-15)
...
- **FL22** is the furthest-left wall corner at distance 2
  ...
  - Rendered in Section 9 (Distance 0) after FL1_B check
  - Visible only when FL1_B wall is absent AND bit flag clear
...
**Visual Representation - FR1_A and FR1_B Wall and Door:**
...
Legend: ⬛🟫 Background | 🟪 FR1_A Wall | 🟦 FR1_B Wall | 🟧 FR1_A Door | 🟩 FR1_B Door
...
- **FR1_A and FR1_B** are the front-right wall sections at distance 1 (columns 16-23, rows 8-15)
...
- **FR22** is the furthest-right wall corner at distance 2
  ...
  - Only has EMPTY variant - draws black (⬛) to clear the area
  - Rendered in Section 9b (Distance 0 Right Side) after FR1_B check
  - Visible only when FR1_B wall is absent AND bit flag clear
